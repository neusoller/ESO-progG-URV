...
GARLIC_spriteSet:
	...
	mov r4, #0
	mov lr, pc
	ldr pc, [r4, #36]		@; llamada indirecta a rutina 0x05
	pop {r4, pc}
...
GARLIC_spriteMove:
	...
	mov r4, #0
	mov lr, pc
	ldr pc, [r4, #40]		@; llamada indirecta a rutina 0x06
	pop {r4, pc}
...
GARLIC_spriteShow:
	...
	mov r4, #0
	mov lr, pc
	ldr pc, [r4, #44]		@; llamada indirecta a rutina 0x07
	pop {r4, pc}
...
GARLIC_spriteHide:
	...
	mov r4, #0
	mov lr, pc
	ldr pc, [r4, #48]		@; llamada indirecta a rutina 0x08
	pop {r4, pc}
