...
_ga_printchar:
	...
	push {r4}				@; pasar 4o parámetro (núm. ventana) por la pila
	bl _gg_escribirCar
	add sp, #4				@; eliminar 4a parámetro de la pila
	pop {r4-r8, pc}
...
_ga_printmat:
	...
	ldr r4, [r5]
	and r4, #0xf			@; R4 = ventana de salida (zócalo actual)
	push {r4}				@; pasar 4a parámetro (núm. ventana) por la pila
	bl _gg_escribirMat
	add sp, #4				@; eliminar 4a parámetro de la pila
	pop {r4-r5, pc}
...
_ga_spriteSet:
	...
	bl _gg_spriteSet		@; llamada a la función definida en "garlic_graf.c"
	pop {r4, pc}
...
_ga_spriteMove:
	...
	ldr r3, [r4]
	and r3, #0xf			@; R3 = ventana de salida (zócalo actual MOD 4)
	bl _gg_spriteMove		@; llamada a la función definida en "garlic_graf.c"
	pop {r4, pc}
...
_ga_spriteShow:
	...
	ldr r3, [r4]
	and r3, #0xf			@; R3 = ventana de salida (zócalo actual MOD 4)
	bl _gg_spriteShow		@; llamada a la función definida en "garlic_graf.c"
	pop {r4, pc}
...
_ga_spriteHide:
	...
	ldr r3, [r4]
	and r3, #0xf			@; R3 = ventana de salida (zócalo actual MOD 4)
	bl _gg_spriteHide		@; llamada a la función definida en "garlic_graf.c"
	pop {r4, pc}
